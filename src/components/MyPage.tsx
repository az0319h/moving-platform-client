        ...
        <div style={{ display: "flex", alignItems: "center", gap: 20 }}>
          ...
          <div>
            ...
            <div style={{ marginTop: 10, fontSize: 14 }}>
              <span style={{ fontWeight: "bold", color: "#f59e0b" }}>★ 5.0</span>{" "}
              (178) ㆍ 경력 7년 ㆍ 334건 확정
            </div>
            <div style={{ marginTop: 5, fontSize: 14 }}>
              제공 서비스: <strong>소형이사, 가정이사</strong> ㆍ 지역: 서울, 경기
            </div>
          </div>
        </div>
      </section>
        ...
        {reviews.map((review) => (
          ...
          >
            ...
            >
              ...
              <span style={{ color: "#999", fontSize: 12 }}>{review.date}</span>
            </div>
            <div style={{ color: "#f59e0b" }}>
              {"★".repeat(review.rating)}
              {"☆".repeat(5 - review.rating)}
            </div>
            <p style={{ whiteSpace: "pre-line", marginTop: 8 }}>{review.text}</p>
          </div>
        ))}
      </section>
    </div>
